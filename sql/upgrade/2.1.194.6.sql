ALTER TABLE `users` add COLUMN IF NOT EXISTS `trainercode` varchar(12) CHARACTER SET utf8mb4 DEFAULT NULL AFTER `trainername`;
...
ALTER TABLE `raids` ADD COLUMN IF NOT EXISTS `event_note` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL AFTER `event`;
